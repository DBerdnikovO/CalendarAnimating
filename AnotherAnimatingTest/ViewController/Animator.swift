...
//
//        // 11
//        self.cellImageViewRect = selectedCell.myVIew.convert(selectedCell.myVIew.bounds, to: window)
//
//        // 46
//        self.cellLabelRect = selectedCell.mylabel.convert(selectedCell.mylabel.bounds, to: window)
//    }
//
//    // 12
...
//            let cellImageSnapshot = selectedCell.myVIew.snapshotView(afterScreenUpdates: true),
//            let controllerImageSnapshot = secondViewController.locationImageView.snapshotView(afterScreenUpdates: true),
//            let cellLabelSnapshot = selectedCell.mylabel.snapshotView(afterScreenUpdates: true), // 47
